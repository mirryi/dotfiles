...
M.init = function()
    ...
    packer.startup(function()
        ...
        local luse = function(spec)
            ...
            M.status[name] = false
            spec.config = spec.config .. 'require"plugins".status["' .. name ..
                              '"] = true'
        ...
        luse {
            ...
            config = function() require 'plugins.easy-align' end
        }
        ...
        -- Jump locations
        luse {'phaazon/hop.nvim', config = function()
            require 'plugins.hop'
        end}
        ...
        -- Good TeX support
        luse {'lervag/vimtex', config = function()
        ...
        luse {
            ...
            config = function() require 'plugins.projectconfig' end
        }
    end, {
        config = {
            display = {
...
M.wait = function(name, f) co.wait(function() return M.status[name] end, f) end
