...
c.colors.contextmenu.menu.fg = base00
...
c.colors.hints.match.fg = base00

# Text color for the keyhint widget.
c.colors.keyhint.fg = base00

# Highlight color for keys to complete the current keychain.
c.colors.keyhint.suffix.fg = base00
...
c.colors.statusbar.url.hover.fg = base00
